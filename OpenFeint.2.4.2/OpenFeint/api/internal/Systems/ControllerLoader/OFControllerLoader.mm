...
{
    // NOTE(serhiys): check do we have the specified resource.
    // othertwise loadNibNamed will be crashed.
    
    NSBundle * mainBundle = [NSBundle mainBundle];
    
    NSString * pathForResource = [mainBundle pathForResource:nibName ofType:@"nib"];
    if (!pathForResource)
    {
        return nil;
    }
	...
	NSArray* objects = [mainBundle loadNibNamed:nibName owner:owner options:nil];
